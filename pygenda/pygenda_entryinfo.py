...
class EntryInfo:
    ...
    def set_repeat_info(self, reptype:str, interval:int=None, count:int=None, until:dt_date=None, byday:Union[str,list]=None, bymonth:str=None, bymonthday:str=None, except_list=None, anniv=False) -> None:
