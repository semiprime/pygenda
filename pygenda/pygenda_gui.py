...
class GUI:
    ...
    def _init_comboboxes(cls) -> None:
        ...
        for cb_id in ('combo_event_calendar','combo_repeat_type','combo_repeaton_year','combo_repeaton_month','combo_repeaton_week','combo_status','combo_todo_list','combo_todo_calendar','combo_todo_priority','combo_todo_status'):
